...
Integritätsrisiko
Daten wären inkonsistent oder regelwidrig.

Workload-Risiko
Die DB schafft die erwartete Last nicht.

Latenz-Risiko
Operationen im kritischen Pfad werden zu langsam.

Modellierungsrisiko
Dein Datenmodell passt nicht zur Engine.

Operations-Risiko
Betrieb, Backups, Monitoring sind nicht beherrschbar.

Evolutions-Risiko
Änderungen am Produkt wären später fast unmöglich.
...
Chunk Retrieval (konsistenz-irrelevant)

3.2 Workload-Form („Shape“) – wie die Engine belastet wird
Nutze deine Messwerte aus Modul 2.

Typische Formen:

read-heavy → Dokumente, Chunks → Mongo
...
Wenn dein Datenmodell gegen die Engine arbeitet, ist das Risiko hoch.

3.6 Operability (Betriebsfähigkeit)
