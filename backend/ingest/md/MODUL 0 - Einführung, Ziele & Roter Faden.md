# MODUL 0 — Einführung, Ziele & Roter Faden
...
1. Datenarten verstehen
2. Workloads analysieren
3. Datenmodelle entwerfen
4. DB-Technologie auswählen
5. Systemdesign / Query Paths bauen
