# MODUL 4 Labor — Kritische Pfade unter Last verifizieren
...
**Messgröße (Pflicht):** Latenz der ANN-Abfrage in Abhängigkeit von Concurrent Queries und den Hierarchical Navigable Small Worlds HNSW-Index-Parametern (z.B. M, ef). Siehe: <https://www.pinecone.io/learn/series/faiss/hnsw/>
...
**Missing Prerequisite:** Der Beweis, dass das Small Document-Modell (Modul 5/6) und die Index-Optimierung die 60 ms Budget unter Peak-Load einhalten.
